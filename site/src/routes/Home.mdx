...
<div className="hint">
  Press <Kbd action="global:0-help" /> for shortcuts, <Kbd action="global:1-omnibar" /> for command palette, or start a sequence (e.g. <code>G</code>…).
</div>
  ...
  <div className="demo-item">
    ...
    <div className="demo-content">
      ...
      <ul>
        ...
        <li><strong>Custom remove-button styling</strong>: inline "×" (instead of corner badge)</li>
      </ul>
    </div>
  </div>
  <div className="demo-item">
